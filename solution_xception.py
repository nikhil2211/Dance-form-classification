# -*- coding: utf-8 -*-
"""
Created on Sat Jul  4 01:21:59 2020
...
# load dataset
train_data = np.array([img_to_array(load_img(img, target_size=(364, 364)))
...
test_data_fin = np.array([img_to_array(load_img(img, target_size=(364, 364)))
...
#saving the csv file
test_data.to_csv('test_xception.csv',header =False,index = False)